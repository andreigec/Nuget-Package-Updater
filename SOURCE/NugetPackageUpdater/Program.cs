...
namespace NugetPackageUpdater
{
    class Program
    {
        ...
        private static void PackagesChanges(string packageName, string forceversion = null, string startDir = null)
        {
            ...
            foreach (var f in files)
            {
                ...
                foreach (Match m in nugets)
                {
                    ...
                    var newversion = forceversion ?? NugetHelpers.GetNewestVersion(package, NugetRepos, SeenPackageVersions);
        ...
        private static void ProjectFileChanges(string filefilter, string packageName, string forceversion = null, string startDir = null)
        {
            if (startDir == null)
                startDir = Directory.GetCurrentDirectory();
